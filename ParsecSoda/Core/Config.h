...
public:
	...
	public:
		...
		map<string, PermissionGroup> role = { 
			...
			{"white-listed noob", PermissionGroup("!8ball !bonk !cookie !discord !ff !kb !keyboard !limit !mirror !one !pads !ping !playtime !rollcall !rpg !sfx !spectate !swap !triangle /emptyplaytime /exitqueue /help /ignore /listqueue /nay /poll /queue /startcooldown /v /version /votekick /votequestion /yay") },
